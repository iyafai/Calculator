...
namespace Calculator
{
    class XMLParser
    {
        ...
        public void parseSymbolTable()
        {
            ...
            List<SymbolTableMember> symbolTableList = new List<SymbolTableMember>();
            int index = 0;
            string name = "";
            int kind = 0;
            SymbolTableMember member;
            ...
            while (node != null)
            {
                ...
                member = new SymbolTableMember(index, name, kind);
        ...
        public void parseRuleTable()
        {
            ...
            List<RuleTableMember> ruleTableList = new List<RuleTableMember>();
            ...
            while (node != null)
            {
                ...
                member = new RuleTableMember(index, nonterminalIndex, symbolCount, symbolIndices);
        ...
        public void parseCharSetTable()
        {
            ...
            List<CharSetTableMember> charSetTableList = new List<CharSetTableMember>();
            XmlNode node = charSetTable.FirstChild;
            int index = 0;
            int count = 0;
            XmlNode nodeChild = null;
            List<char> charList = new List<char>();
            CharSetTableMember member;
            while (node != null)
            {
                index = Convert.ToInt32(node.Attributes["Index"].InnerText);
                ...
                member = new CharSetTableMember(index, count, charList);
